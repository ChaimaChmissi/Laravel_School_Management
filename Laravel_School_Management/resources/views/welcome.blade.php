...
<style>
.button {/* COLOR FROM SELECTED ITEMS */
...
.button:hover {/* COLOR FROM SELECTED ITEMS */
color: #7963e5;
...
.descripton1 {
  font-family: Poppins, sans-serif Impact, Haettenschweiler,
    "Arial Narrow light", sans-serif;
  font-size: 20px;
  color: #3a3d53;
  position: relative;
  left: 190px;
