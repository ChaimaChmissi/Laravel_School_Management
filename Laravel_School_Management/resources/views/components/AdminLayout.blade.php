...
<body>
    <nav>
        <div class="logo-name">
            ...
            <span class="logo_name" style="color: #7963e5">StudyNet</span>
        </div>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                <li><a href="/Courses">
                    ...
                    <span class="link-name">Results of classes</span>
                </a></li>
               
                <li><a href="/subjects-list">
                ...
                <li><a href="/teachers-list">
                    <i class="uil uil-files-landscapes"></i>
                    <span class="link-name">Teachers</span>
                </a></li>
                <li>

                <li><a href="/classes-list">
